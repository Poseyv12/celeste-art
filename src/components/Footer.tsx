      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-600">Celeste@example.com</p>
          ...
          <div>
            ...
            <p className="text-neutral-700 mb-4">
              Subscribe to receive updates about new artwork and exhibitions
            </p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-2 rounded-md border border-neutral-200 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none text-foreground placeholder:text-neutral-500"
              />
              <button
                type="submit"
                className="w-full bg-primary hover:bg-primary-600 text-white py-2 rounded-md transition duration-300 shadow-sm hover:shadow"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-200">
          <p className="text-center text-neutral-600">
            © {new Date().getFullYear()} Celeste Art. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
